  ...
  <div class="flex h-screen w-full bg-slate-900 text-slate-200 font-sans overflow-hidden">
    ...
    >
      ...
      <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
        <NuxtLink to="/" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all hover:bg-slate-800/50 text-slate-400 hover:text-slate-200 border border-transparent font-medium" active-class="!bg-amber-500/10 !text-amber-400 border-amber-500/20 shadow-sm">
        ...
        <NuxtLink to="/lightcones" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all hover:bg-slate-800/50 text-slate-400 hover:text-slate-200 border border-transparent font-medium" active-class="!bg-amber-500/10 !text-amber-400 border-amber-500/20 shadow-sm">
          <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"></path></svg>
          Lightcones
        </NuxtLink>
        <NuxtLink to="/relics" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all hover:bg-slate-800/50 text-slate-400 hover:text-slate-200 border border-transparent font-medium" active-class="!bg-amber-500/10 !text-amber-400 border-amber-500/20 shadow-sm">
