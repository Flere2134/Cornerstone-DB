...
<template>
  <div class="p-8 max-w-[1400px] mx-auto pb-20">
    ...
    <div class="mb-10 text-center">
      <h1 class="text-4xl font-bold mb-2 tracking-tight">Cornerstone DB</h1>
      <p class="text-slate-400">Honkai: Star Rail Character Database</p>
    </div>
      ...
      >
        ...
        <div class="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-950 via-slate-900/80 to-transparent pt-16 pb-3 px-3 flex flex-col justify-end">
          ...
          <div class="flex items-center space-x-1">
            ...
            <span class="bg-slate-800/80 px-1 py-0.5 rounded backdrop-blur-sm border border-slate-600/30">
              <NuxtImg 
                :src="`https://raw.githubusercontent.com/Mar-7th/StarRailRes/master/icon/element/${character.element}.png`" 
                width="14" height="14" 
                alt="Element"
              />
            </span>
